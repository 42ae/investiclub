 ...
 * @package     Controller
 */
class Ajax_DocumentsController extends Zend_Controller_Action
{
    /**
     * User's instance
    ...
    public function addAction()
    {
        ...
        if ($this->_getParam('createfile')) {
            $form->removeElement('file');
        }
        
        $data = $this->getRequest()->getPost();
        if ($form->isValid($data)) {
            //$datastore->saveFile($form->getValues(), Ivc::getCurrentMember()->member_id);
            //$m = $datastore->getMessageInstance()->push(Ivc_Message::ERROR, 'Fuck you dolphin');
